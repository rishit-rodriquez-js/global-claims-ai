...
import { Search, Bell, Shield, Sparkles, User } from 'lucide-react';

export default function Header({ searchQuery, setSearchQuery, onNewClaimClick }) {
  return (
        ...
        <div class="flex items-center gap-2 pl-2 border-l border-slate-800">
          ...
          <div class="flex items-center gap-2.5 pl-2">
            ...
            <div class="hidden lg:block text-left">
              <p class="text-xs font-semibold text-white leading-none">Senior Officer</p>
              <p class="text-[10px] text-slate-400">GenAI Designathon Reviewer</p>
            </div>
          </div>
        </div>
      </div>
